...
| **Razor Group** | Berlin | $1.7bn, Mar 2024, Perch merger financing | [TechCrunch](https://techcrunch.com/2024/03/04/razor-and-perch-merge-raise-100m-on-a-1-7b-valuation-as-more-roll-ups-consolidate/) |
...
- **Razor Group**'s valuation carries a `disputed` note. TechCrunch's headline calls the
  $1.7bn a valuation; the same article's body calls it the *enterprise value* of the merged
  Razor–Perch business, carried with about $400m of debt. Those are not the same measure, and
  the record says so rather than quietly publishing the larger reading.
...
| **Enpal** | Berlin | €2.2bn at the €215m Series D ([Sifted, 2023-01-09](https://sifted.eu/articles/enpal-215m-solar-panels-news)) | The April 2025 €110m round postdates that valuation, and [Sifted](https://sifted.eu/articles/enpal-e110m-tpg-equity) records that "Enpal declined to comment on the valuation the round gives the company". The register refuses to publish a valuation older than the newest round, so this needs a post-April-2025 figure |
| **1KOMMA5°** | Hamburg | Unicorn at 23 months on a €430m Series B, "valued at over $1 billion" ([Tech.eu, 2023-06-23](https://tech.eu/2023/06/23/hamburg-s-1komma5-has-raised-430-million-and-just-become-a-unicorn-at-just-23-months-old/)) | Same shape as Enpal. The €150m pre-IPO round closed Dec 2024 and was extended Jul 2025; [Sifted](https://sifted.eu/articles/1komma5-e150m-pre-ipo-news) reports "a slight increase in valuation" but that the company "did not disclose an updated figure" |
| **Scalable Capital** | Munich | Flat $1.4bn at the Dec 2023 round ([TechCrunch](https://techcrunch.com/2023/12/06/european-neobroker-scalable-capital-raises-65m-on-a-flat-1-4b-valuation/)) | The €155m June 2025 round — its largest — postdates it, and neither the company nor [EU-Startups](https://www.eu-startups.com/2025/06/german-startup-scalable-capital-receives-e155-million-to-continue-to-expand-its-digital-investment-platform/) gives a valuation |
...
| **sennder** | Berlin | Crossed $1bn on a $160m round in January 2021 | The last figure is four years old and the newer one never closed: [Tech.eu (2022-12-14)](https://tech.eu/2022/12/14/sennder/) reports sennder "**taking on** funds at around double the $1 billion or so value it received for equity issued January 2021" — a raise being primed, not a completed post-money |
